...
# Output
my_output <- paste("busco_figure_woohoo.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('Long-read Assembly', 'Long-read Assembly', 'Long-read Assembly', 'Long-read Assembly', 'Hybrid Assembly', 'Hybrid Assembly', 'Hybrid Assembly', 'Hybrid Assembly')
...
my_percentage <- c(32.6, 28.0, 6.1, 33.3, 60.4, 30.1, 4.0, 5.5)
my_values <- c(446, 383, 84, 454, 825, 411, 55, 76)
