...
annots <- fread("cricket_hybrid_emapper.emapper.annotations", skip=4, fill=T, na.string="-")
...
ggsave(file="hybrid_venn_diagram.svg", plot=vd, width=10, height=8)

##25800 transcripts have at least one of those annotations
